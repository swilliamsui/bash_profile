...
alias bfg='java -jar ~/src/bfg.jar'

alias sauceTunnel='~/bin/sc -u mc-uxe-swilliams -k 8bdf18cd-e00e-47f3-a630-400729bc9ebd'

# chrome
alias chromeAudioReset='sudo killall coreaudiod'
